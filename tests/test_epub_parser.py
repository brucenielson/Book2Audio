...
class TestParseSection:
    ...
    def test_multiple_paragraphs_accumulated(self) -> None:
    ...
    def test_section_header_emitted_as_paragraph(self) -> None:
        parser = make_parser()
    ...
    def test_meta_contains_paragraph_number(self) -> None:
        parser = make_parser()
...
class TestRun:
    ...
    def test_sections_to_skip_multiple(self) -> None:
        book = make_epub_book("My Book", [
    ...
    def test_generate_text_file_creates_files(self, tmp_path) -> None:
        book = make_epub_book("My Book", [
            make_epub_item("chapter1", "<p>Some content.</p>")
        ])

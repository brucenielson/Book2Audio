...
class TestAudioGenerator:
    ...
    def test_generate_delegates_to_engine(self, audio_generator, mock_engine):
    ...
    def test_save_uses_engine_sample_rate(self, mock_engine, tmp_path):
...
class TestKokoroEngine:
    ...
    def test_generate_concatenates_segments(self):
    ...
    def test_generate_calls_pipeline_with_correct_args(self):
...
class TestBookToAudio:
    ...
    def test_dry_run_skips_audio_generation(self, mock_audio_generator):
